...
public class UserData {
	...
	public UserData(String userName, String userSndName,
			String userMainAddress, String userHomeTelephone,
			String userMobilePhone, String userWorkTelephone, String userEmail,
			String userBrthDay, String userBrthMonth, String userBrthYear,
			String userGroupName, String userSndAddress, String userSndPhone) {
